# core/application/handlers/reports/get_report_formats_handler.py
"""
Get Report Formats Handler - معالج استعلام صيغ التقارير
"""
...
class GetReportFormatsHandler(BaseQueryHandler[GetReportFormatsQuery, List[Dict[str, Any]]]):
    """
