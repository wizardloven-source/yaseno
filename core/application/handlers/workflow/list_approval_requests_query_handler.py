...
class ListApprovalRequestsQueryHandler(BaseQueryHandler[ListRequestsQuery, List[ApprovalRequestDTO]]):
    """
    ظ…ط¹ط§ظ„ط¬ ط§ط³طھط¹ظ„ط§ظ… ظ„ظ‚ط§ط¦ظ…ط© ط·ظ„ط¨ط§طھ ط§ظ„ظ…ظˆط§ظپظ‚ط©
    """
    ...
    def handle(self, query: ListRequestsQuery, user_context: UserContext = None) -> List[ApprovalRequestDTO]:
        """
        طھظ†ظپظٹط° ط¬ظ„ط¨ ظ‚ط§ط¦ظ…ط© ط·ظ„ط¨ط§طھ ط§ظ„ظ…ظˆط§ظپظ‚ط©
        
        Args:
            query: ط§ط³طھط¹ظ„ط§ظ… ظ‚ط§ط¦ظ…ط© ط·ظ„ط¨ط§طھ ط§ظ„ظ…ظˆط§ظپظ‚ط©
        
        Returns:
            List[ApprovalRequestDTO]: ظ‚ط§ط¦ظ…ط© ط·ظ„ط¨ط§طھ ط§ظ„ظ…ظˆط§ظپظ‚ط©
        """
        logger.debug(f"Listing approval requests: type={query.entity_type}, status={query.status}")
        ...
        if query.approver_id:
            ...
            requests = self._request_repo.list_by_entity_type(
