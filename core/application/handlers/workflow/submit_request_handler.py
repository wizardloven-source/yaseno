# core/application/handlers/workflow/submit_request_handler.py
"""
Submit Request Handler - معالج تقديم طلب للموافقة
"""
...
class SubmitRequestHandler(BaseHandler[SubmitRequestCommand, ApprovalRequestDTO]):
    """
    معالج تقديم طلب للموافقة
    
    يقوم بتقديم طلب الموافقة وبدء سير العمل.
    """
