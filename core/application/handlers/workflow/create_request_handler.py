# core/application/handlers/workflow/create_request_handler.py
"""
Create Request Handler - معالج إنشاء طلب موافقة
"""
...
class CreateRequestHandler(BaseHandler[CreateApprovalRequestCommand, ApprovalRequestDTO]):
    """
