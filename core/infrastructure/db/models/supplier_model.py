# core/infrastructure/db/models/supplier_model.py
"""Supplier ORM Model"""
...
class SupplierModel(Base):
    ...
    __table_args__ = (
        Index("idx_suppliers_code_status", "code", "status"),
        Index("idx_suppliers_name", "name"),
        Index("idx_suppliers_status_deleted", "status", "is_deleted"),
        Index("idx_suppliers_phone", "phone"),
        Index("idx_suppliers_email", "email"),
    )

    def __repr__(self) -> str:
        return f"SupplierModel(id={self.id}, code={self.code}, name={self.name}, status={self.status})"